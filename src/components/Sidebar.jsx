...
export default function Sidebar({ activeTab, setActiveTab, tabs }) {
  return (
    <aside className="hidden sm:flex w-20 lg:w-64 shrink-0 border-r border-white/20 dark:border-white/10 bg-white/40 dark:bg-slate-900/40 backdrop-blur-xl flex-col py-6">
